      ...
      <Carousel setApi={setApi} className="w-full h-full">
            ...
            >
              <div className="min-h-24 flex flex-col gap-3 items-center justify-start px-4">
                <div className="h-16 inline-flex items-start justify-center text-center">
                  <h1 className="text-xl mt-auto text-foreground font-semibold">
                    {item.title}
                  </h1>
                </div>
                {item.subtitle && (
              ...
              <div className="grow w-full rounded-2xl relative overflow-hidden ">
                ...
                <div className="grow px-4 rounded-t-2xl pt-1.5 overflow-hidden">
                  <Image
                    src={item.imageURL}
                    alt={`preview-${index}`}
                    width={512}
        ...
        <div className="z-[999] w-full">
          <CarouselNext
            variant={'default'}
            className={` w-12 h-12 ${
              items.length === 1 && 'left-1/2 -translate-x-1/2 z-[999]'
            }`}
  ...
  return (
    <svg
      ...
      className={`${
        props.isActive
          ? ' fill-[#FF6914]'
          : 'text-transparent fill-[#FFFFFF] opacity-30'
      } z-[999] `}
    >
